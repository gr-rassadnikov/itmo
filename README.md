...
[HW - 2.7 ](https://github.com/gr-rassadnikov/itmo/blob/main/sem-4/ml/main.cpp) | Изоморфизм Карри-Ховарда.

### Методы оптимизации

[HW - 1](https://github.com/gr-rassadnikov/itmo/tree/main/sem-4/mo/lab-1-public) | [Условие](https://github.com/gr-rassadnikov/itmo/blob/main/sem-4/mo/lab-1-public/lab_1_optimization.pdf) | Градиент. Метод дихотомии, метод Фибоначчи, метод золотого сечения. Генератор случайных квадратичных функций n переменных с числом обусловленности k. Одномерный поиск с учетом условий Вольфе.

### Дискретная математика

[LAB - 1](https://github.com/gr-rassadnikov/itmo/tree/main/sem-4/dm/lab-1) | [Условие]() |Производящие функции.

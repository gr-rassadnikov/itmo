# itmo 
Репозиторий с собственными решениями задач, с которыми я столкнулся во время учебы. Работы выложены для просмотра моих навыков и задач, которые удалось решить. Не допускается копироване, списывание кода, дальнейшее примение в образовательных целях.
Меня зовут Рассадников Григорий. Я студент университета ИТМО факультета ФИТиП по направлению Прикладная математика и информатика, известной как кафедра КТ (Компьютерные технологии)
